...
class TradeMarksDataTables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('photo', 'admin.trademarks.btn.photo')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
        ...
        return $this->builder()
                    ...
                    ->parameters(
                        [
                            ...
                            'buttons' =>[
                                 [
                                    'text'=>'<i class = "fa fa-plus">'.trans('admin.create_trade_marke').'</i>','className'=>'btn btn-info','action'=>'function(){
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name' => 'name_ar',
                'data' =>'name_ar',
                'title' => trans('admin.trade_name_ar'),
            ],
            [
                'name' => 'name_en',
                'data' =>'name_en',
                'title' => trans('admin.trade_name_en'),
            ],
            [
                'name' => 'photo',
                'data' =>'photo',
