...
class ReviewsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.review.btn.checkbox')
            ->addColumn('delete', 'admin.review.btn.delete')
            ->addColumn('showReview', 'admin.review.btn.showReview')
            ->rawColumns([
                'delete',
                'checkbox',
                'showReview',
