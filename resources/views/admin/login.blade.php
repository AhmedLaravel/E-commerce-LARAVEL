...
<div class="login-box">
  <div class="login-logo">
    <a href="{{aurl()}}"><b>{{trans('admin.admin')}}</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">{{trans('admin.sign_in')}}</button>
        </div>
        <br>
        <br>
        <center>  
        <div >
          <a href="{{aurl('forgot/password')}}" type="submit" class="btn btn-primary">{{trans('admin.forgot_password')}}</a>
        </div>
        </center>
        <!-- /.col -->
      </div>
