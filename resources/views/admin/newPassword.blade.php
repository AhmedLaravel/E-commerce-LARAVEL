...
<div class="login-box">
  <div class="login-logo">
    <a href="{{url('design/adminLTE/index2.html')}}"><b>{{trans('admin.admin')}}</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">{{trans('admin.sing_in_start_session')}}</p>
    <form method="post">
      {!! csrf_field() !!}
      ...
      <div class="form-group has-feedback">
        <input type="password" name="password_confirmation" class="form-control" placeholder="Enter The Confirmation Password">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">{{trans('admin.set')}}</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
